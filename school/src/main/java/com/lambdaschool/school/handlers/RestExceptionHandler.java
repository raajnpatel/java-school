...
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<?> handleResourceFoundException(Exception rnfe, HttpServletRequest request)
    {
        ...
        errorDetail.setDevelopermeddage(rnfe.getClass().getName());
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request)
    {
        ...
        errorDetail.setDevelopermeddage(request.getDescription(true));
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatus status, WebRequest request)
    {
        ...
        errorDetail.setDevelopermeddage("Rest Handler Not Found(check for valid URI");
